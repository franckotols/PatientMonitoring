...
public class HomePazienteNavDrawer extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_paziente_nav_drawer);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.home_paziente_nav_drawer, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent settingsIntent = new Intent(HomePazienteNavDrawer.this, SettingsActivity.class);
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.nav_menu1:
                fragment = new ParametriMainFragment();
                String s = "Parametri: "+nome;
                setTitle(s);
                break;
            case R.id.nav_menu2:
                //fragment = new Menu2();
